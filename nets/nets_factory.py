...
def get_network_fn(name, num_classes, reuse, scope, conv1_scope, postnorm_scope, logits_scope, weight_decay=0.0, is_training=False):
  ...
  def network_fn(images, **kwargs):
    ...
    with slim.arg_scope(arg_scope):
      return func(images, num_classes, is_training=is_training, reuse=reuse, scope=scope,conv1_scope=conv1_scope, postnorm_scope=postnorm_scope, logits_scope=logits_scope, **kwargs)
